...
class AnimalPage:
    def __init__(self, master,ZooApp):
        ...
        # Load the logo
        logo = Image.open("images/logo.png")  # Replace "logo.png" with the path to your logo image file

        # Resize the logo
        logo = logo.resize((100, 100), Image.ANTIALIAS)  # Replace (100, 100) with the size you want
